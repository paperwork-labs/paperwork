...
Auth & Dependencies
-------------------
- `app/api/dependencies.py` provides `get_current_user` (placeholder) and `get_admin_user`
...
--------------------------
- Portfolio stocks: `app/api/routes/portfolio_stocks.py`
- Portfolio options: `app/api/routes/portfolio_options.py`
- Portfolio statements/dividends/live: respective `portfolio_*.py` files
- Technicals/market data: `app/api/routes/market_data.py`
