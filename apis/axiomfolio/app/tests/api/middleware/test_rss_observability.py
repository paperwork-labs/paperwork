...
def test_middleware_invokes_rss_record_with_growing_maxrss(
    ...
    monkeypatch.setattr("app.api.middleware.rss_observability.resource.getrusage", fake_getrusage)
    monkeypatch.setattr("app.api.middleware.rss_observability._get_sync_redis", lambda: r)

    with patch("app.api.middleware.rss_observability.record_request_rss_peak") as m_rec:
        app = FastAPI()
