...
class TestIBKRClient:
    ...
    async def test_connect_success(self, client):
        ...
        with patch("app.services.clients.ibkr_client.IB", return_value=mock_ib):
    ...
    async def test_connect_with_retry(self, client):
        ...
        with (
            patch("app.services.clients.ibkr_client.IB", return_value=mock_ib),
            patch("app.services.clients.ibkr_client.util"),
            patch("asyncio.sleep"),
        ):
