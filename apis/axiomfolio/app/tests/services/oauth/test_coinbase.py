"""Tests for :mod:`app.services.oauth.coinbase`."""
...
from app.services.oauth.base import OAuthCallbackContext, OAuthError
from app.services.oauth.coinbase import CoinbaseOAuthAdapter
...
@patch("app.services.oauth.coinbase.requests.Session.post")
@patch("app.services.oauth.coinbase.settings")
