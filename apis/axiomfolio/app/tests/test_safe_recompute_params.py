...
def test_safe_recompute_passes_force_true_and_config_days():
    ...
    with (
        ...
        patch("app.tasks.market.indicators.recompute_universe", side_effect=fake_recompute) as mock_rc,
        patch("app.tasks.market.history.snapshot_last_n_days", side_effect=fake_snapshot_last_n) as mock_sn,
