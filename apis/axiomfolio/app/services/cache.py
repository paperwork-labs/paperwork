...
`app/services/risk/pre_trade_validator.py`,
`app/tasks/portfolio/sync.py`,
`app/api/routes/webhooks/tradingview.py`) but did not exist, causing every
...
def get_redis_client() -> redis.Redis:
    ...
    if _redis_client is None:
        ...
        logger.info("app.services.cache.redis_client initialized")
