...
TOOL_TO_CELERY_TASK: Dict[str, str] = {
    ...
    "record_daily": "app.tasks.market.history.record_daily",
    "compute_regime": "app.tasks.market.regime.compute_daily",
    "monitor_coverage": "app.tasks.market.coverage.health_check",
    "recover_stale_jobs": "app.tasks.market.maintenance.recover_jobs",
    "bootstrap_coverage": "app.tasks.market.coverage.daily_bootstrap",
    "refresh_index_constituents": "app.tasks.market.backfill.constituents",
    "fill_missing_fundamentals": "app.tasks.market.fundamentals.fill_missing",
    "deep_backfill": "app.tasks.market.backfill.full_historical",
}
