...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column(
            "portfolio_enabled", sa.Boolean(), nullable=False, server_default=sa.text("false")
        ),
        sa.Column(
            "strategy_enabled", sa.Boolean(), nullable=False, server_default=sa.text("false")
        ),
        sa.Column(
            "created_at",
    ...
    op.create_index(
        op.f("ix_cron_schedule_audit_schedule_id"),
        "cron_schedule_audit",
        ["schedule_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_historical_iv_symbol_date"), "historical_iv", ["symbol", "date"], unique=False
    )
    ...
    op.create_index(
        op.f("idx_index_active"), "index_constituents", ["index_name", "is_active"], unique=False
    )
    op.create_index(op.f("ix_index_constituents_id"), "index_constituents", ["id"], unique=False)
    op.create_index(
        op.f("ix_index_constituents_index_name"), "index_constituents", ["index_name"], unique=False
    )
    op.create_index(
        op.f("ix_index_constituents_is_active"), "index_constituents", ["is_active"], unique=False
    )
    op.create_index(
        op.f("ix_index_constituents_symbol"), "index_constituents", ["symbol"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_institutional_holdings_cik"),
        "institutional_holdings",
        ["institution_cik"],
        unique=False,
    )
    op.create_index(
        op.f("ix_institutional_holdings_filing_date"),
        "institutional_holdings",
        ["filing_date"],
        unique=False,
    )
    op.create_index(
        op.f("ix_institutional_holdings_id"), "institutional_holdings", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_institutional_holdings_institution_cik"),
        "institutional_holdings",
        ["institution_cik"],
        unique=False,
    )
    op.create_index(
        op.f("ix_institutional_holdings_symbol"), "institutional_holdings", ["symbol"], unique=False
    )
    op.create_index(
        op.f("ix_institutional_holdings_symbol_period"),
        "institutional_holdings",
        ["symbol", "period_date"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "option_style",
            postgresql.ENUM("AMERICAN", "EUROPEAN", name="optionstyle", create_type=True),
            nullable=True,
        ),
    ...
    op.create_index(
        op.f("idx_instruments_expiration"), "instruments", ["expiration_date"], unique=False
    )
    ...
    op.create_index(
        op.f("idx_instruments_underlying"), "instruments", ["underlying_symbol"], unique=False
    )
    ...
    op.create_index(
        op.f("idx_jobrun_status_time"), "job_run", ["status", "started_at"], unique=False
    )
    op.create_index(
        op.f("idx_jobrun_task_time"), "job_run", ["task_name", "started_at"], unique=False
    )
    ...
    op.create_index(
        op.f("idx_symbol_type"), "market_data_cache", ["symbol", "data_type"], unique=True
    )
    ...
    op.create_index(
        op.f("ix_market_regime_as_of_date"), "market_regime", ["as_of_date"], unique=True
    )
    ...
    op.create_index(
        op.f("idx_analysis_timestamp"), "market_snapshot", ["analysis_timestamp"], unique=False
    )
    op.create_index(
        op.f("idx_symbol_analysis_type"),
        "market_snapshot",
        ["symbol", "analysis_type"],
        unique=False,
    )
    op.create_index(
        op.f("idx_symbol_analysis_type_ts"),
        "market_snapshot",
        ["symbol", "analysis_type", "analysis_timestamp"],
        unique=False,
    )
    op.create_index(
        op.f("idx_symbol_expiry"), "market_snapshot", ["symbol", "expiry_timestamp"], unique=False
    )
    ...
    op.create_index(
        op.f("idx_hist_symbol_date"),
        "market_snapshot_history",
        ["symbol", "as_of_date"],
        unique=False,
    )
    op.create_index(
        op.f("ix_market_snapshot_history_as_of_date"),
        "market_snapshot_history",
        ["as_of_date"],
        unique=False,
    )
    op.create_index(
        op.f("ix_market_snapshot_history_id"), "market_snapshot_history", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_market_snapshot_history_symbol"),
        "market_snapshot_history",
        ["symbol"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "role",
            postgresql.ENUM(
                "ADMIN", "USER", "READONLY", "ANALYST", name="userrole", create_type=True
            ),
            nullable=False,
    ...
    op.create_index(
        op.f("ix_agent_actions_risk_level"), "agent_actions", ["risk_level"], unique=False
    )
    op.create_index(
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            postgresql.ENUM(
                "ACTIVE", "INACTIVE", "CLOSED", "SUSPENDED", name="accountstatus", create_type=True
            ),
            nullable=False,
        ),
    ...
    op.create_index(
        op.f("idx_accounts_number"), "broker_accounts", ["account_number"], unique=False
    )
    op.create_index(
        op.f("idx_accounts_sync_status"), "broker_accounts", ["sync_status"], unique=False
    )
    op.create_index(
        op.f("idx_accounts_user_broker"), "broker_accounts", ["user_id", "broker"], unique=False
    )
    op.create_index(
        op.f("ix_broker_accounts_account_number"),
        "broker_accounts",
        ["account_number"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("idx_aliases_symbol"), "instrument_aliases", ["alias_symbol"], unique=False
    )
    op.create_index(
        op.f("ix_instrument_aliases_alias_symbol"),
        "instrument_aliases",
        ["alias_symbol"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_market_tracked_plan_symbol"), "market_tracked_plan", ["symbol"], unique=False
    )
    op.create_index(
        op.f("ix_market_tracked_plan_updated_by_user_id"),
        "market_tracked_plan",
        ["updated_by_user_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("idx_symbol_interval_date"), "price_data", ["symbol", "interval", "date"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_price_data_instrument_id"), "price_data", ["instrument_id"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "execution_mode",
            postgresql.ENUM("PAPER", "LIVE", "BACKTEST", name="executionmode", create_type=True),
            nullable=True,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "role",
            postgresql.ENUM(
                "ADMIN", "USER", "READONLY", "ANALYST", name="userrole", create_type=False
            ),
            nullable=False,
    ...
    op.create_index(
        op.f("idx_watchlist_user_symbol"), "watchlists", ["user_id", "symbol"], unique=False
    )
    ...
    op.create_index(
        op.f("idx_syncs_account_date"), "account_syncs", ["account_id", "started_at"], unique=False
    )
    op.create_index(
        op.f("ix_account_syncs_account_id"), "account_syncs", ["account_id"], unique=False
    )
    ...
    op.create_index(
        op.f("idx_backtest_status_date"), "backtest_runs", ["status", "created_at"], unique=False
    )
    op.create_index(
        op.f("idx_strategy_backtest"), "backtest_runs", ["strategy_id", "created_at"], unique=False
    )
    ...
    op.create_index(
        op.f("idx_account_symbol_exdate"),
        "dividends",
    ...
    op.create_index(
        op.f("ix_margin_interest_from_date"), "margin_interest", ["from_date"], unique=False
    )
    op.create_index(
        op.f("ix_margin_interest_to_date"), "margin_interest", ["to_date"], unique=False
    )
    ...
    op.create_index(
        op.f("idx_orders_status_created_at"), "orders", ["status", "created_at"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(["account_id"], ["broker_accounts.id"]),
        sa.UniqueConstraint(
            "user_id", "account_id", "as_of_date", name="uix_portfolio_history_user_account_date"
        ),
        sa.ForeignKeyConstraint(["user_id"], ["users.id"]),
    )
    op.create_index(
        op.f("ix_portfolio_history_account_id"), "portfolio_history", ["account_id"], unique=False
    )
    op.create_index(
        op.f("ix_portfolio_history_as_of_date"), "portfolio_history", ["as_of_date"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        op.f("idx_account_date"),
        "portfolio_snapshots",
        ["account_id", "snapshot_date"],
        unique=False,
    )
    op.create_index(
        op.f("idx_snapshot_date"), "portfolio_snapshots", ["snapshot_date"], unique=False
    )
    ...
    op.create_index(
        op.f("idx_period_dates"),
        "strategy_performance",
        ["period_start", "period_end"],
        unique=False,
    )
    op.create_index(
        op.f("idx_strategy_period"),
        "strategy_performance",
        ["strategy_id", "period_type"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "execution_mode",
            postgresql.ENUM("PAPER", "LIVE", "BACKTEST", name="executionmode", create_type=False),
            nullable=False,
        ),
    ...
    op.create_index(
        op.f("idx_strategy_run_date"), "strategy_runs", ["strategy_id", "run_date"], unique=False
    )
    op.create_index(
        op.f("idx_strategy_run_status_date"), "strategy_runs", ["status", "run_date"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_tax_lots_acquisition_date"), "tax_lots", ["acquisition_date"], unique=False
    )
    ...
    op.create_index(
        op.f("idx_trades_account_symbol_time"),
        "trades",
        ["account_id", "symbol", "execution_time"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("idx_account_status"),
        "transaction_sync_status",
        ["account_id", "sync_status"],
        unique=False,
    )
    op.create_index(
        op.f("idx_last_sync"), "transaction_sync_status", ["last_sync_date"], unique=False
    )
    ...
    op.create_index(
        op.f("idx_account_symbol_date"),
        "transactions",
        ["account_id", "symbol", "transaction_date"],
        unique=False,
    )
    op.create_index(op.f("idx_external_id"), "transactions", ["external_id"], unique=False)
    op.create_index(
        op.f("idx_transaction_date"), "transactions", ["transaction_date"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_transfers_transaction_id"), "transfers", ["transaction_id"], unique=True
    )
    op.create_index(
        op.f("ix_transfers_transfer_date"), "transfers", ["transfer_date"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            postgresql.ENUM("OPEN", "CLOSED", "EXPIRED", name="positionstatus", create_type=True),
            nullable=False,
        ),
    ...
    op.create_index(
        op.f("idx_positions_user_account"), "positions", ["user_id", "account_id"], unique=False
    )
    ...
    op.create_index(
        op.f("idx_signal_type_status"), "signals", ["signal_type", "status"], unique=False
    )
    op.create_index(
        op.f("idx_signals_symbol_date"), "signals", ["symbol", "generated_at"], unique=False
    )
    ...
    op.create_index(
        op.f("idx_position_history_position_date"),
        "position_history",
        ["position_id", "snapshot_date"],
        unique=False,
    )
    op.create_index(
        op.f("idx_position_history_user_date"),
        "position_history",
        ["user_id", "snapshot_date"],
        unique=False,
    )
    op.create_index(
        op.f("ix_position_history_position_id"), "position_history", ["position_id"], unique=False
    )
    op.create_index(
        op.f("ix_position_history_snapshot_date"),
        "position_history",
        ["snapshot_date"],
        unique=False,
    )
    op.create_index(
        op.f("ix_position_history_user_id"), "position_history", ["user_id"], unique=False
    )
