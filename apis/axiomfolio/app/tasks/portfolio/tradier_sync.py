...
Mirrors :mod:`app.tasks.portfolio.etrade_sync` — walks every
...
routes into :class:`app.services.bronze.tradier.TradierSyncService`
...
@shared_task(
    name="app.tasks.account_sync.sync_all_tradier_accounts",
