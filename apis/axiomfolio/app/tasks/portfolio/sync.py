...
@shared_task(name="app.tasks.account_sync.sync_all_ibkr_accounts")
...
@shared_task(name="app.tasks.account_sync.sync_all_schwab_accounts")
...
@shared_task(name="app.tasks.account_sync.recover_stale_syncs", soft_time_limit=60, time_limit=120)
