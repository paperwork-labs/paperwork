...
class PipelineOrchestrator:
    ...
    def _run_ibkr_sync(self) -> int:
        ...
        # Wire to app.tasks.portfolio.sync.sync_all_ibkr_accounts (or .delay()) when orchestrating for real.
    ...
    def _run_indicator_compute(self) -> int:
        ...
        # Wire to app.tasks.market.indicators.recompute_universe when orchestrating for real.
    ...
    def _run_history_append(self) -> int:
        ...
        # Wire to app.tasks.market.history.record_daily when orchestrating for real.
        logger.info("Running history append")
        return 0

    def _run_regime_update(self) -> int:
        """Step 6: Update market regime."""
        # Wire to app.tasks.market.regime.compute_daily when orchestrating for real.
    ...
    def _run_reconciliation(self) -> int:
        ...
        # Wire to app.tasks.portfolio.reconciliation.reconcile_positions when orchestrating for real.
        logger.info("Running position reconciliation")
        return 0

    def _run_cleanup(self) -> int:
        """Step 10: Cleanup stale data."""
        # Wire to app.tasks.market.maintenance.prune_old_bars / audit tasks when orchestrating for real.
