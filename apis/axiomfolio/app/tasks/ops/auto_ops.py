...
REMEDIATION_MAP = {
    "coverage": [
        ...
        ("app.tasks.market.backfill.stale_daily", {}),
        ("app.tasks.market.coverage.health_check", {}),
    ],
    "stage_quality": [
        ("app.tasks.market.indicators.recompute_universe", {"batch_size": 50}),
        ("app.tasks.market.indicators.repair_stage_history", {"days": 120}),
    ],
    "jobs": [
        ("app.tasks.market.maintenance.recover_jobs", {"stale_minutes": 120}),
    ],
    "audit": [
        ("app.tasks.market.history.record_daily", {}),
        ("app.tasks.market.maintenance.audit_quality", {}),
    ],
    "regime": [
        ("app.tasks.market.regime.compute_daily", {}),
    ],
    "fundamentals": [
        ("app.tasks.market.fundamentals.fill_missing", {"limit_per_run": 500}),
    ],
    "ibkr_gateway": [
    ...
    "portfolio_sync": [
        ...
        ("app.tasks.account_sync.sync_all_schwab_accounts", {}),
    ],
}
...
@shared_task(
    name="app.tasks.auto_ops_tasks.auto_remediate_health",
    soft_time_limit=120,
    time_limit=180,
)
