...
Scheduled every 30 minutes (see ``backend/tasks/job_catalog.py`` ›
...
from backend.services.oauth import OAuthError, get_adapter
...
@shared_task(
    name="backend.tasks.portfolio.oauth_token_refresh.refresh_expiring_tokens",
    soft_time_limit=240,
    time_limit=300,
)
