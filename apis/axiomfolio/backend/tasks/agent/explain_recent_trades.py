...
from backend.models import Order, TradeDecisionExplanation
from backend.services.agent.trade_decision_explainer import (
    OrderNotFoundError,
...
@shared_task(
    name="backend.tasks.agent.explain_recent_trades.explain_recent_trades",
    soft_time_limit=870,
    time_limit=900,
    autoretry_for=(),
)
...
def explain_recent_trades(lookback_hours: int = 24) -> Dict[str, Any]:
    ...
    iron law in :mod:`backend.tasks.job_catalog`.
    """
