...
from backend.services.picks import generators  # noqa: F401 — register generators
from backend.services.picks.candidate_generator import run_all_generators
...
@celery_app.task(
    name="backend.tasks.candidates.generate_candidates_daily",
    soft_time_limit=570,
    time_limit=600,
    queue="heavy",
)
