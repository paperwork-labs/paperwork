...
from backend.api.routes.portfolio.options import router
...
class TestUnifiedPortfolioMultiBroker:
    def test_schwab_and_ibkr_positions_both_appear(self, app, client):
        ...
        with patch(
            "backend.api.middleware.response_cache.redis_response_cache",
...
class TestChainSources:
    def test_reports_sources_list_with_kind(self, app, client):
        ...
        with patch(
            "backend.api.routes.portfolio.options.probe_chain_sources",
