...
def test_source_unavailable_returns_503(
    ...
    def _boom(*a, **k):
        from backend.services.gold.options_chain_surface import (
    ...
    monkeypatch.setattr(
        "backend.services.gold.options_chain_surface."
...
def test_read_latest_snapshot_200(client_with_db, db_session):
    from backend.models.market.options_chain_snapshot import (
