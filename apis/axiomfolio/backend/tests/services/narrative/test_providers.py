...
from backend.services.narrative.builder import build_narrative_prompt, render_narrative
from backend.services.narrative.provider import NarrativeProviderError, NarrativeResult
...
from backend.services.narrative.providers.stub import StubNarrativeProvider
