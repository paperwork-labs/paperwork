...
from backend.services.execution.risk_gate import RiskGate, RiskViolation, MAX_ORDER_VALUE
...
class TestOrderManagerPreview:
    ...
    async def test_preview_passes_with_small_order(self, manager):
        ...
        # Mock broker preview
        with patch("backend.services.execution.order_manager.broker_router") as mock_router:
            ...
            # Mock Order creation
            with patch("backend.services.execution.order_manager.Order") as MockOrder:
