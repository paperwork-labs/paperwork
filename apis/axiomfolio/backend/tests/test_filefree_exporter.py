...
from backend.services.tax.mapper import build_package
from backend.services.tax.schemas import (
    SCHEMA_VERSION,
    DataQuality,
    InstrumentType,
    LotTerm,
)
from backend.services.tax.serialization import CSV_COLUMNS, package_to_csv
...
class TestPackageValidation:
    def test_extra_fields_rejected(self):
        ...
        from backend.services.tax.schemas import FileFreeAccount
