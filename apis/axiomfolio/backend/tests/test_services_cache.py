"""Tests for backend.services.cache — the module whose absence silently
...
def test_module_imports() -> None:
    """The module must exist so `from backend.services.cache import redis_client`
...
def test_module_attr_redis_client_lazy() -> None:
    """`from backend.services.cache import redis_client` triggers
