...
Typical usage from process bootstrap (FastAPI startup or Celery worker init):
    ...
    from backend.observability import init_tracing, init_metrics
...
from backend.observability.metrics import init_metrics, get_meter
from backend.observability.span_decorators import traced
from backend.observability.tracing import init_tracing, get_tracer
