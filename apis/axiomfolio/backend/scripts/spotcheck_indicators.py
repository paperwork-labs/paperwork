...
Usage:
    python -m backend.scripts.spotcheck_indicators --symbol AAPL --indicator rsi
    python -m backend.scripts.spotcheck_indicators --symbol SPY --indicator sma --period 50
