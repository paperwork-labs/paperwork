...
from app.routers import admin, admin_expenses, admin_learning, brain, health, webhooks, workstreams
...
app.include_router(admin_expenses.router, prefix="/api/v1")
app.include_router(admin_expenses.rules_router, prefix="/api/v1")
app.include_router(admin_expenses.backfill_router, prefix="/api/v1")
