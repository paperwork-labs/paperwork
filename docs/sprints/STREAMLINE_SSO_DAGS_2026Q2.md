...
- shipped 2026-04-26: **Track H4** — `apps/accounts` Next.js scaffold as primary Clerk host for `accounts.paperworklabs.com` (Paperwork ID splash + `/sign-in` / `/sign-up`, parent slate + amber Clerk appearance). PR #236.
