...
| D119 | 2026-04-20 | **Founder year-end target ($4M from $1.4M) explicitly counter-proposed; AxiomFolio's discipline-bounded realistic-aggressive anchor for the joint book is $2.0M–$2.5M by 2026-12-31.** The $4M target requires 186% gain in 8 months (≈330% annualized), which is lottery-ticket territory — top professional outcomes in great years are 25–80% annualized; even legendary years (Druckenmiller/Soros best, ARK 2020) topped at ~150% before subsequent multi-year drawdown. Reaching $4M from $1.4M requires either (a) ~3× sustained leverage with zero drawdowns and zero margin calls — practical survival probability low; (b) concentrated long-dated calls on names that 5–10× — negative expected value because base-rate of lottery tickets is ~95% loss; or (c) catching a vertical market regime — possible but not plannable. Compounding at 50% per year for 5 years from $1.4M reaches $10.6M; at 30% per year reaches $5.2M. Going for $4M and blowing up reaches $400k and a decade of recovery. The discipline thesis (D113, D116) is the only path that survives multiple regimes. RiskGate, position sizing, MAX_SINGLE_POSITION_PCT, and Kill Switch (5% daily loss) will block the position sizing required to plan for $4M; that block IS the product working correctly. Anchor for founder-portfolio replay (D118) is therefore: at year-end, did the discipline-bounded outcome land in $1.95M–$2.5M range AND did the system surface the correct G14/G15 alerts on the founder's actual book? If yes, the discipline thesis is validated for raising/recruiting/pricing. If no, iterate on the engines, not the target. Reversible if a true regime tailwind appears mid-year (revisit then with fresh data, never with hope). |
