...
### D78 — Hetzner Server Transfer + n8n Slack-First Agent Deployment (2026-03-17)
- **Context**: Hetzner CX33 server (204.168.147.100) was running under a personal account. Needed to transfer to the new billing@paperworklabs.com Hetzner account. Meanwhile, all 6 existing n8n workflows were outputting to Notion (which was removed from the stack). n8n databases were previously wiped (D31) and needed full re-setup. The agent architecture needed to shift from Notion-based output to Slack-first interactive conversations.
