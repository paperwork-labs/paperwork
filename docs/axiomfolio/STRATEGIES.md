...
- **Rule Evaluator** (`app/services/strategy/rule_evaluator.py`): Evaluates nested condition groups against market data
- **Backtest Engine** (`app/services/strategy/backtest_engine.py`): Replays rules against MarketSnapshotHistory
- **Signal Generator** (`app/services/strategy/signal_generator.py`): Converts rule matches to actionable signals
- **Templates** (`app/services/strategy/templates.py`): Pre-built hedge fund strategy configurations
