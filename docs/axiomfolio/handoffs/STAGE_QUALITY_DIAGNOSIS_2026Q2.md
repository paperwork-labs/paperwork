...
- `app/services/market/admin_health_service.py:44` — hardcoded
  `"stage_monotonicity_max": 15`.
- `app/services/market/admin_health_service.py:415-419` — binary AND
  across `unknown_rate / invalid / monotonicity`.
- `app/services/market/stage_quality_service.py:158-186` — counter
