...
- **T5.1** Wave K3: removed `apis/filefree/tax-data/` duplicate — FileFree consumes canonical JSON via [`packages/python/data-engine/`](../../packages/python/data-engine/) reading [`packages/data/src/tax/`](../../packages/data/src/tax/) (status: [`docs/audits/WAVE_K3_TAX_DATA_DEDUP_STATUS_2026-Q2.md`](../audits/WAVE_K3_TAX_DATA_DEDUP_STATUS_2026-Q2.md)). Pydantic ↔ Zod schema-drift CI guard. M, P0. Legal-risk class bug per `no-silent-fallback.mdc`.
