...
import { setColorPalettePreference } from "../hooks/useUserPreferences";
import { getSeriesPalette } from "../constants/chart";
...
export const SeriesPaletteDefault = () => (
  <div className="flex flex-col gap-6 p-6">
    <PaletteRow heading="Default series palette (theme-aware)" />
  </div>
);

export const SeriesPaletteColorBlind = () => {
  React.useEffect(() => {
