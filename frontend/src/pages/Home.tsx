...
function SectionHeading({ children, to, onMouseEnter }: SectionHeadingProps) {
  const content = (
  ...
  if (to) {
    return (
      <Link to={to} onMouseEnter={onMouseEnter} className="inline-flex">
        {content}
      </Link>
    );
  }
      ...
      <div className="flex flex-col gap-5">
        ...
        <section aria-label="Attention feed">
          <div className="mb-2 flex items-center justify-between">
            <SectionHeading to="/portfolio" onMouseEnter={prefetchPositions}>
              Attention
            </SectionHeading>
          </div>
          <NerveCenter />
        ...
        <section aria-label="Top holdings">
          <div className="mb-2 flex items-center justify-between">
            <SectionHeading to="/portfolio/holdings" onMouseEnter={prefetchPositions}>
              Book
            </SectionHeading>
          </div>
          <YourBook />
