        ...
        <Card>
          ...
          <CardContent>
            {currentStep === 'welcome' && (
              <div className="space-y-4">
                ...
                <p className="text-muted-foreground">
                  Let&apos;s get you set up in just a few steps. You&apos;ll be analyzing the market
                  with Stage Analysis in no time.
                </p>
            ...
            {currentStep === 'broker' && (
              <div className="space-y-4">
                <p className="text-muted-foreground">
                  Connect your brokerage to sync positions and enable trading.
                </p>
                <div className="grid gap-3">
                  ...
                  <Button variant="outline" className="justify-start h-auto p-4">
                    ...
                    <div className="text-left">
                      ...
                      <p className="text-xs text-muted-foreground">API key + Paper trading</p>
                    </div>
                  </Button>
                </div>
