...
const RiskTab: React.FC = () => {
  ...
  const marginItems = marginQuery.data;
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      ) : !dividendQuery.isPending && !dividendQuery.isError ? (
      ...
      {marginQuery.isPending ? (
        ...
        <p className={cn('text-sm', semanticTextColorClass('status.danger'))} role="alert">
          Failed to load margin interest.
        </p>
      ...
      {balancesQuery.isPending ? (
        ...
        <p className={cn('text-sm', semanticTextColorClass('status.danger'))} role="alert">
          Failed to load balances for account health.
        </p>
      ) : balances && balances.some((b: Record<string, unknown>) => b.initial_margin_req != null) ? (
        <div>
      ...
      ) : !balancesQuery.isPending && balances && balances.length > 0 ? (
