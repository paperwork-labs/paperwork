/**
 * Illinois Portal Handler
 *
 * Tier 2 portal automation for Illinois Secretary of State.
 * Extends BasePortalHandler with IL-specific field mapping.
 */
...
export class IllinoisPortalHandler extends BasePortalHandler {
  readonly supportedStates = ["IL"];
  protected readonly config: PortalConfig;

  constructor() {
    super();
    this.config = loadPortalConfig("IL");
  }

  canHandle(stateCode: string): boolean {
    return stateCode.toUpperCase() === "IL";
  }
