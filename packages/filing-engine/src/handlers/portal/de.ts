/**
 * Delaware Portal Handler
 *
 * Tier 2 portal automation for Delaware Division of Corporations.
 */
...
export class DelawarePortalHandler extends BasePortalHandler {
  readonly supportedStates = ["DE"];
  protected readonly config: PortalConfig;

  constructor() {
    super();
    this.config = loadPortalConfig("DE");
  }

  canHandle(stateCode: string): boolean {
    return stateCode.toUpperCase() === "DE";
  }
