...
from backend.services.gold.options_chain_surface import OptionsChainSurface
...
@shared_task(
    name="backend.tasks.market.options_chain.refresh_options_chain_for_symbol",
    soft_time_limit=55,
    time_limit=60,
)
@task_run(
...
@shared_task(
    name="backend.tasks.market.options_chain."
