...
from backend.services.narrative.builder import build_portfolio_summary, render_narrative
from backend.services.narrative.persistence import fetch_fresh_narrative, persist_narrative
from backend.services.narrative.providers.openai_chat import OpenAIChatProvider
...
@shared_task(
    name="backend.tasks.portfolio.daily_narrative.generate_daily_narrative",
    soft_time_limit=90,
    time_limit=120,
)
...
@shared_task(
    name="backend.tasks.portfolio.daily_narrative.fanout_daily_narratives",
    soft_time_limit=540,
    time_limit=600,
)
