"""Tests for :mod:`backend.services.oauth.tradier`."""
...
from backend.services.oauth.base import OAuthCallbackContext
from backend.services.oauth.tradier import TradierOAuth2Adapter


@patch("backend.services.oauth.tradier.settings")
...
@patch("backend.services.oauth.tradier.settings")
@patch("backend.services.oauth.tradier.TradierOAuth2Adapter._post_token")
