...
from backend.services.ops.universe_coverage import run_universe_coverage_check
...
def test_admin_health_universe_degraded_uses_no_silent_ok() -> None:
    with patch(
        "backend.services.ops.universe_coverage.read_universe_coverage_for_admin_health",
        return_value={
            "state": "degraded",
            "gaps_total": 2,
            "users_checked": 1,
