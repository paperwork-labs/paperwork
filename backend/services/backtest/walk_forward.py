...
:class:`backend.services.strategy.walk_forward.WalkForwardAnalyzer`. The
...
1. The caller supplies a ``StrategyBuilder`` callable that turns a
   ...
   :class:`backend.services.strategy.backtest_engine.BacktestEngine`. We
...
from backend.services.strategy.backtest_engine import BacktestEngine, BacktestTrade
from backend.services.strategy.rule_evaluator import ConditionGroup
