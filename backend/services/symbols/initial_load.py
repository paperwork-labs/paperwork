...
Operational use::
    ...
    docker-compose exec api python -m backend.services.symbols.initial_load --commit
...
from backend.services.symbols.symbol_master_service import SymbolMasterService
