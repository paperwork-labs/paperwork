...
from backend.models.corporate_action import CorporateAction, CorporateActionType
from backend.models.market_data import MarketSnapshot, PriceData
...
def recompute_position_day_pnl(
    ...
    *,
    ...
    """
    from backend.models.position import PositionType  # late import: avoid cycle
