...
def build_nightly_pipeline(db_session_factory) -> PipelineRunner:
    """Build the standard nightly market data pipeline.

    This is the canonical pipeline order:
    1. Refresh index constituents
    2. Update tracked universe
