...
We mount this as a sibling of :mod:`backend.api.routes.portfolio.stocks` so
...
from backend.services.tax.schemas import SCHEMA_VERSION
from backend.services.tax.serialization import package_to_csv
