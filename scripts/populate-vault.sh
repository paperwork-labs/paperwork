...
push_secret "SLACK_ALERTS_WEBHOOK_URL" "https://hooks.slack.com/services/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" "slack" "Hetzner .env / GitHub Actions" "Incoming webhook for #alerts channel"

# ---------- GitHub ----------
echo ""
echo "=== GitHub ==="
push_secret "GITHUB_PAT" "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" "github" "Hetzner .env / n8n" "GitHub OAuth token for n8n workflows"
push_secret "GITHUB_PAT_FINEGRAINED" "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" "github" "n8n credential" "Fine-grained PAT (paperwork-labs org, repo read)"

# ---------- OpenAI ----------
echo ""
echo "=== OpenAI ==="
push_secret "OPENAI_API_KEY" "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" "openai" "n8n credential" "OpenAI project API key for GPT-4o / GPT-4o-mini"
