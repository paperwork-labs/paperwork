/**
 * Florida Articles of Organization — Limited Liability Company
 *
 * PDF template for Florida LLC formation using @react-pdf/renderer.
 * Based on Florida Division of Corporations requirements.
 *
 * Filing fee: $125
 * State law: Florida Statutes Section 605.0201
 */
...
export interface FLArticlesProps {
  llcName: string;
  principalAddress: {
    street: string;
    city: string;
...
export function FLArticlesOfOrganization({
  llcName,
  principalAddress,
  mailingAddress,
  registeredAgent,
      ...
      <Page size="LETTER" style={styles.page}>
        <View style={styles.header}>
          ...
          <Text style={styles.subtitle}>
            Limited Liability Company — Florida Statutes Section 605.0201
          </Text>
          <Text style={styles.subtitle}>
            Department of State, Division of Corporations — Filing fee: $125
          </Text>
        </View>
        ...
        <View style={styles.article}>
          ...
          <Text style={styles.articleText}>
            The street address of the principal office of the limited liability
            company is:
          </Text>
        ...
        {mailingAddress && (
          <View style={styles.article}>
            <Text style={styles.articleNumber}>ARTICLE III — MAILING ADDRESS</Text>
            <Text style={styles.articleText}>
              The mailing address of the limited liability company (if different
              from principal office) is:
            </Text>
            <View style={styles.address}>
        ...
        <View style={styles.article}>
          <Text style={styles.articleNumber}>
            ARTICLE {mailingAddress ? "IV" : "III"} — REGISTERED AGENT
          </Text>
          <Text style={styles.articleText}>
        ...
        {effectiveDate ? (
          <View style={styles.article}>
            <Text style={styles.articleNumber}>
              ARTICLE {mailingAddress ? "V" : "IV"} — EFFECTIVE DATE
            </Text>
            <Text style={styles.articleText}>
              These articles of organization shall be effective on:{" "}
              {effectiveDate}
            </Text>
          </View>
        ) : (
          <View style={styles.article}>
            ...
            <Text style={styles.articleText}>
              Effective date: upon filing with the Department of State (no
...
export default FLArticlesOfOrganization;
