...
} from "@axiomfolio/components/charts/ChartCrosshair";
import { ErrorState } from "@axiomfolio/components/ui/ErrorState";
import { RichTooltip } from "@axiomfolio/components/ui/RichTooltip";
import { SegmentedPeriodSelector } from "@axiomfolio/components/ui/SegmentedPeriodSelector";
...
export const SegmentedMedium: Story = {
  render: () => {
...
export const RichTooltipHover: Story = {
  render: () => (
...
export const RichTooltipClick: Story = {
  render: () => (
  <div className="p-12">
    <RichTooltip
      openOn="click"
