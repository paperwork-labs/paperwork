      ...
      <Card className="mt-6">
        <CardContent className="space-y-6 pt-6">
          ...
          <p className="text-xs text-muted-foreground">
            Preferences here are UI placeholders until wired to the notifications API. Open the center for full history
            and actions.
          </p>
          <Button type="button" size="sm" variant="outline" onClick={() => router.push("/notifications")}>
