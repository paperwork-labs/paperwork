...
export default function WhyFreeClient() {
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main>
        <PageContainer width="default">
          ...
          <Section>
            <h2 className="font-heading text-2xl font-semibold tracking-tight sm:text-3xl">Why we use CSV instead of Plaid</h2>
            <div className="mt-8 flex flex-col gap-5 text-sm leading-relaxed text-muted-foreground sm:text-base">
              ...
              <p>At 10,000 users with two accounts each, that&apos;s substantial monthly cost before we earn a dollar.</p>
              <p>
          ...
          <Section>
            <h2 className="font-heading text-2xl font-semibold tracking-tight sm:text-3xl">What we&apos;ll never do</h2>
            <ul className="mt-8 flex flex-col gap-4">
              {neverItems.map((item) => (
